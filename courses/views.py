...
class ContentCreateUpdateView(PermissionRequiredMixin, TemplateResponseMixin, View):
	...
	permission_required = ('courses.add_content', 'courses.change_content')
...
class ModuleOrderView(CsrfExemptMixin, PermissionRequiredMixin, JsonRequestResponseMixin, View):
	permission_required = 'courses.change_module'
...
class ContentOrderView(CsrfExemptMixin, PermissionRequiredMixin, JsonRequestResponseMixin, View):
	permission_required = 'courses.change_content'
	def post(self, request):
		for id, order in self.request_json.items():
...
class CourseDetailView(DetailView):
	...
	def get_context_data(self, **kwargs):
		...
		context['has_enrolled'] = False
		if self.request.user.is_authenticated:
			if self.object in list(self.request.user.courses_joined.all()):
				context['has_enrolled'] = True
		return context